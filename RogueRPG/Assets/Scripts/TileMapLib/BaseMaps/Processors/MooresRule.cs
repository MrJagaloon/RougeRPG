...
{
    [System.Serializable]
    public class MooresRule : ICellularAutomataRule
    {
        public bool[] bornRules;
        public bool[] surviveRules;

        public MooresRule(bool[] bornRules, bool[] surviveRules)
        {
        ...
        int GetAdjacentFullCount(BaseMap<bool> map, int x, int y)
        {
            int count = 0;
    ...
    [CustomPropertyDrawer(typeof(MooresRule))]
