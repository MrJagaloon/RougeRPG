...
namespace Board
{
    public class BoardManager : MonoBehaviour
    {
        ...
        void PlaceEntrance()
        {
            ...
            Zone entryZone = zones[entryZoneIndex];
        ...
        bool PlaceExit()
        {
            ...
            int exitZoneIndex = 0;
            Zone exitZone = zones[exitZoneIndex];
        ...
        bool PlaceTileInZone(Zone zone, GameObject tile, int minAdjBlocking = 0)
        {
